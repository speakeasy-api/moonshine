...
const buttonVariants = cva(
  'relative inline-flex items-center justify-center whitespace-nowrap text-sm font-mono uppercase tracking-[0.01em] transition-all select-none cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[color:var(--color-brand-blue-600)] dark:focus-visible:ring-[color:var(--color-brand-blue-300)] focus-visible:ring-offset-[color:var(--color-base-white)] dark:focus-visible:ring-offset-[color:var(--color-base-black)] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0',
  {
    variants: {
      context: {
        product: 'rounded-sm',
