        ...
        <div className="flex w-2/3 flex-col items-center justify-center px-8">
          <div className="flex max-w-lg flex-col">
            ...
            <div className="flex flex-col">
              <div className="mt-5 flex w-full max-w-[660px] flex-row items-center justify-stretch gap-2 rounded-md border border-neutral-softest bg-input/10 px-4 py-1 shadow-muted transition-[border-color] duration-500 ease-in-out-expo focus-within:shadow-sm focus-within:outline focus-within:outline-offset-0 focus-within:outline-muted/50 data-[invalid=true]:border-red-400/75">
