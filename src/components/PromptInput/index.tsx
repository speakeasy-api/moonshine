  ...
  return (
    <div className="flex w-full flex-col">
      <div
        ...
        className={cn(
          "flex flex-col rounded-md border bg-background pt-2 text-sm text-foreground/70 dark:text-body-muted",
          isDraggingOver && "border-dashed border-primary/60",
        )}
      >
        <div
          className={cn(
        ...
        >
          <textarea
            className="min-h-[inherit] w-full resize-none rounded-md border border-none bg-transparent px-3 py-1.5 text-foreground selection:bg-primary/20 selection:text-primary focus:outline-none dark:selection:bg-primary/20 dark:selection:text-primary [&::-webkit-scrollbar]:!invisible"
        ...
        <div id="actions-bar" className="flex items-center p-2">
          <div
            id="file-upload"
            className={cn(
              "relative flex cursor-pointer items-center gap-1 rounded-md p-1.5 text-foreground hover:bg-accent/80",
          ...
          <div className="ml-auto">
            <motion.button
              ...
              className="rounded-md border bg-foreground/5 p-2 text-foreground/60 disabled:!bg-background/70 disabled:!text-body-muted dark:bg-foreground dark:text-background"
        ...
        <div className="mt-4 flex w-full flex-row flex-wrap gap-3">
          {suggestions.map((suggestion) => (
            <button
              ...
              className={cn(
                "relative flex cursor-pointer flex-row items-center gap-1.5 rounded-md border bg-foreground/5 px-2.5 py-2 text-sm tracking-tight whitespace-nowrap text-foreground/80 select-none hover:bg-foreground/10",
            ...
            >
              {suggestion.icon && (
                <Icon
                  ...
                  className={cn(
                    "relative size-4 stroke-primary",
...
function AttachmentPreview({ attachment }: { attachment: Attachment }) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex flex-row items-center rounded-lg border bg-card px-1.5 py-1 text-xs",
        img && "gap-1.5",
      )}
      key={attachment.id}
    >
