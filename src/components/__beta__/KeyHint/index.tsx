...
export function KeyHint({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="text-muted dark:text-muted/80 flex w-full flex-row items-center self-start border-b px-2.5 py-0.5 text-[10px] font-semibold tracking-wide uppercase select-none">
        <div>{titleText}</div>
        {dismissable && (
          <div
