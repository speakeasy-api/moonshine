...
export function AIChatMessageTextPart({
  ...
  return (
    <div
      className={cn(
        "prose prose-sm min-w-0 break-words dark:prose-invert",
        ...
        "prose-a:font-normal prose-a:tracking-[0.0025em] prose-a:text-link prose-a:decoration-1 prose-a:underline-offset-4",
        className,
      )}
    >
